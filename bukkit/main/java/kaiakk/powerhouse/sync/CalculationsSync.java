...
public class CalculationsSync {
    ...
    public static Map<Item, List<Item>> scanItemMergeCandidates(List<Item> items) {
        ...
        Map<ItemSnapshot, List<ItemSnapshot>> snapResult = kaiakk.powerhouse.async.Calculations.scanItemMergeCandidatesSnapshots(snaps);
    ...
    public static int calculateMergedAmount(Item target, List<Item> toMerge) {
        ...
        return kaiakk.powerhouse.async.Calculations.calculateMergedAmountSnapshot(tSnap, snaps);
    }
}
