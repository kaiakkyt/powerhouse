...
public final class PowerhouseAPI {
    ...
    /**
     * Check whether a proxy has been detected or configured for this server.
     * @return true if a proxy is present or configured
     */
    public static boolean isProxyPresent() {
        try {
            return ProxyAwareness.isProxyPresent();
        } catch (Throwable ignored) {
            return false;
        }
    }
    ...
    /**
     * Get a human-friendly proxy type value (e.g. "NONE", "BUNGEE", "VELOCITY", "MIXED", or "CONFIGURED_ONLY").
     */
    public static String getProxyType() {
        try {
            return ProxyAwareness.getDetectedProxyType();
        } catch (Throwable ignored) {
            return "NONE";
        }
    }
