...
public class DynamicScaler {
    ...
    private final kaiakk.powerhouse.sync.MetricCollector metrics;
    ...
    public DynamicScaler(Plugin plugin, kaiakk.powerhouse.sync.MetricCollector metrics, int pollIntervalTicks) {
        this.plugin = plugin;
